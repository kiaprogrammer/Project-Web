        ...
        <div class="content">
            ...
            <div class="main-content">
                ...
                <div class="categories">
                    <h3>Kategori</h3>
                    <img alt="Pie chart showing categories: Filsafat 20%, Fiksi 20%, Religi 30%" src="https://storage.googleapis.com/a1aa/image/zJHYiLajlfQuIKScwDkBIeD5sDVKCHAE1ATHrVeQfJZh2guOB.jpg">
                </div>
            </div>
        </div>
    </div>
