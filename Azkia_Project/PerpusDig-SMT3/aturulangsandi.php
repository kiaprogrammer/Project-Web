...
<head>
    ...
    <style>
        * {
        ...
        .logo img {
            height: 50px;
            width: 50px;
            margin-right: 0.5rem; /* Memberikan jarak antara gambar dan teks */
        }
        ...
        .image-box {
            ...
            height: 100%; /* Tentukan tinggi kotak gambar sesuai kebutuhan */
            padding: 20px; /* Padding di sekitar konten dalam kotak gambar */
        }

        /* Mengatur gambar di dalam kotak gambar */
        .image-box img {
            max-width: 100%; /* Membatasi lebar gambar agar tidak lebih dari kontainer */
            height: auto; /* Mempertahankan rasio aspek gambar */
            object-fit: cover; /* Memastikan gambar mengisi area dengan seimbang */
        }

        /* Responsif: jika layar lebih kecil, lebar kotak gambar akan menyesuaikan */
        @media (max-width: 768px) {
            .image-box {
                width: 100%; /* Memastikan kotak gambar menggunakan lebar penuh pada layar kecil */
                height: 200px; /* Menurunkan tinggi kotak gambar pada layar kecil */
            }
        }
    ...
    <script>
        ...
        function savePassword() {
            ...
            // Jika semua validasi berhasil, tampilkan pesan sukses dan redirect ke halaman login
            else {
                ...
                window.location.href = "login.php"; // Ganti dengan alamat halaman login yang sesuai
            }
        }
    </script>
</body>
